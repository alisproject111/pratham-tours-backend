...
export const submitBookingRequestLegacy = async (req, res) => {
  try {
...
export const createBookingRequest = async (req, res) => {
  try {
    ...
    const savedRequest = await bookingService.createBookingRequest({
      request_id: requestId,
      customer_name: bookingDetails.fullName,
      customer_email: bookingDetails.email,
      customer_phone: bookingDetails.phone,
    ...
    const savedLeadTraveler = await bookingService.createTraveler({
    ...
    if (bookingDetails.additionalTravelers && bookingDetails.additionalTravelers.length > 0) {
      ...
      const savedAdditionalTravelers = await bookingService.createManyTravelers(additionalTravelersData);
      console.log(
